/**
 * Module Search Console — récupération des données SEO.
 *
 * Utilisé notamment par l'analyse CTR pour :
 * - Identifier les pages à fort potentiel
 * - Récupérer les principales requêtes
 * - Mesurer les performances par page
 *
