...
import { applyGscIndexPolicy } from './case-studies-gsc-policy'
...
export function isCaseStudyIndexable(caseStudy, personalizedData = null) {
  ...
  const gsc = applyGscIndexPolicy(caseStudy)
  if (gsc.forceIndex) return true
  if (gsc.noindex) return false
