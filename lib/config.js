...
export const siteConfig = {
  ...
  youtubeChallenge: {
    ...
    description:
      'Je me lance : une vidéo chaque jour sur le scraping, l’automatisation et le build in public. Suivez le défi en direct sur ma chaîne.',
    cta: 'S’abonner sur YouTube',
  },
  /** Preuves sociales plateformes (à resynchroniser avec les profils publics) */
  socialProof: {
    malt: {
      rating: 5,
      reviews: 115,
  ...
  projects: [
    ...
    },
    {
      ...
      description: 'Preuve entrepreneuriale — plateforme de logements d\'exception co-fondée avec mon frère (week-end).',
  ...
  seo: {
    ...
    pages: {
      ...
      outils: {
        title: 'Marketplace — Bases Google Sheets et scrapers Apify',
        description: 'Les bases et scrapers que je livre déjà à mes clients — en libre-service. Bases Google Sheets pour la prospection, outils Apify pour lancer un scraper vous-même.',
      ...
      aPropos: {
        title: 'À propos',
        description: 'Parcours de growth marketeux chez Airbnb à entrepreneur indépendant. Expert scraping et automatisation. Missions Malt/Fiverr, Outreacher outbound, Logement Atypique.',
