...
export const siteConfig = {
  ...
  seo: {
    ...
    pages: {
      ...
      donneesPubliques: {
        title: 'Données Publiques - Dashboards et Progression',
        description: 'Découvrez mes dashboards et données de progression publiques. Scrapers Apify, projets open source et métriques en temps réel.',
        keywords: ['données publiques', 'dashboard', 'progression', 'scrapers Apify', 'métriques']
      },
      contact: {
