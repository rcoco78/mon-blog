...
export const siteConfig = {
  ...
  ogLogo: 'https://www.corentinrobert.fr/images/profile-picture/pp.png',
  twitter: {
  ...
  projects: [
    {
      ...
      status: 'active',
      image: '/images/profile-picture/pp.png',
  ...
  seo: {
    defaultDescription: 'Corentin Robert - Consultant freelance spécialisé en scraping et automatisation. 424+ projets réalisés via Malt et Fiverr, 20 scrapers publics sur Apify. Expertise en outbound marketing et data automation.',
    baseKeywords: [
      'scraping',
      'automatisation',
      'web scraping',
    ...
    pages: {
      ...
      confidentialite: {
        title: 'Politique de confidentialité | Corentin Robert',
