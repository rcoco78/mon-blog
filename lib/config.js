...
export const siteConfig = {
  ...
  email: 'hello@corentinrobert.fr',
  profileImage: PROFILE_IMAGE,
  /**
   * Look-at avatar (style dahbiahmed).
   * Quand tu as shooté les angles (même lumière/tenue), dépose les fichiers dans
   * public/images/profile-picture/look/{direction}.jpg
   * et liste-les ici. Minimum utile : center, left, right.
   * Directions possibles : center, top, top-right, right, bottom-right,
   * bottom, bottom-left, left, top-left.
   * Tant que la liste est vide → tilt 3D CSS sur la photo unique.
   */
  profileLook: {
    basePath: '/images/profile-picture/look',
    ext: 'jpg',
    directions: [
      'center',
      'left',
  ...
  social: {
    ...
    instagram: 'https://www.instagram.com/logement.atypique',
  ...
  /**
   * Réseau de sites : les projets et collaborations reliés au journal.
   * Le blog pointe. Il ne recopie pas l’offre.
   */
  network: {
    blog: {
      id: 'journal',
      title: 'Journal',
      role: 'Voix',
      description: 'Notes de terrain sur la data, l’outbound et le freelance.',
      href: '/',
      icon: '/images/profile-picture/pp-corentin-robert.jpg',
      iconAlt: 'Corentin Robert',
      iconShape: 'rounded',
      external: false,
    },
    datareacher: {
      ...
      title: 'Datareacher',
      role: 'Produit',
      description: 'Données et scripts. Tu as ta liste ce soir.',
      href: 'https://datareacher.fr',
      icon: '/images/logo-datareacher.png',
      iconAlt: 'Logo Datareacher',
      iconOnDark: 'plate',
      external: true,
    },
    outreacher: {
      ...
      title: 'Outreacher',
      role: 'Service',
      description: 'Outbound. Une campagne en 14 jours, tu appuies sur envoi.',
      href: 'https://outreacher.fr',
      icon: '/images/logo-outreacher.jpeg',
      iconAlt: 'Logo Outreacher',
      iconOnDark: 'plate',
      external: true,
    },
    logement: {
      ...
      iconAlt: 'Logo Logement Atypique',
      iconOnDark: 'plate',
      external: true,
    },
  },
  homepage: {
    topPostsCount: 3,
    // Positionnement : voix / journal, pas une landing produit
    positioning:
      'Un journal de travail sur la data, l’outbound et la vie de freelance.',
  ...
  projects: [
    {
      ...
      description: 'Missions scraping et automatisation (Malt, Fiverr, direct). Données livrées pour des dirigeants qui veulent des résultats rapides.',
    ...
    },
    {
      ...
      link: 'https://outrank.so/?via=corentin',
      status: 'active',
    },
    {
      id: 'rare-item-club',
  ...
  seo: {
    ...
    pages: {
      home: {
        title: 'Freelance Scraping & Automatisation',
        description: 'Expert freelance scraping et automatisation. Centaines de missions livrées via Malt et Fiverr, livraison en 7 jours. Journal public, marketplace de bases Google Sheets.',
      ...
      blog: {
        title: 'Journal — data, outbound et freelance',
        description:
          'Notes de terrain sur le scraping, l’automatisation, l’outbound, les missions freelance et les projets que je construis.',
        keywords: [
          'blog scraping',
      ...
      outils: {
        title: 'Marketplace — Bases Google Sheets',
        description: 'Bases Google Sheets à acheter en libre-service (Stripe, copie Drive). Les scripts de scraping sont sur Datareacher.',
        keywords: ['marketplace scraping', 'bases de données scraping', 'prospection bases Google Sheets', 'bases Google Sheets', 'data prospection']
      },
      aPropos: {
        title: 'À propos',
        description: 'Fondateur · Outreacher · Datareacher · Logement Atypique. Journal public. Freelance scraping et data, Paris.',
