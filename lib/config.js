...
export const siteConfig = {
  ...
  seo: {
    ...
    pages: {
      ...
      outils: {
        title: 'Outils Scraping et Automatisation Gratuits',
        description: 'Outils scraping et automatisation gratuits par Corentin Robert. Générateurs de templates, extracteurs de données, outils de productivité. +4 outils gratuits pour automatiser vos processus business.',
        keywords: ['outils scraping gratuits', 'outils automatisation', 'générateur templates email', 'extracteur linkedin', 'outils gratuits scraping web', 'automatiser processus business gratuit']
      },
      aPropos: {
