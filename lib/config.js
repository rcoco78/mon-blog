...
export const siteConfig = {
  ...
  youtubeChallenge: {
    ...
    startLabel: 'en cours',
    description:
      'Challenge en cours : une vidéo chaque jour sur le scraping, l’automatisation et le build in public. Suivez le défi en direct sur ma chaîne.',
  ...
  /**
   * Réseau de sites : même personne, quatre fonctions.
  ...
  network: {
    blog: {
      ...
      title: 'Journal',
      role: 'Voix',
      description: 'Ce site. Expérimentations, idées, ce que je construis en public.',
      href: '/',
    ...
    logement: {
      ...
      role: 'En parallèle',
      description: 'Lieux filmés. Avec Siméon.',
  ...
  homepage: {
    ...
    positioning:
      'Journal public. Data, outbound, et ce que je construis à côté.',
  ...
  projects: [
    ...
    },
    {
      id: 'logement-atypique',
      title: 'Logement Atypique',
      description: 'Plateforme de mise en avant de logements d’exception. On photographie et on filme pour leur apporter de la visibilité. Avec Siméon.',
  ...
  seo: {
    ...
    pages: {
      ...
      aPropos: {
        title: 'À propos',
        description: 'Je scrappe, j’automatise, je livre de la data. Freelance à Paris — ex-growth Airbnb. Missions Malt/Fiverr, Outreacher, marketplace de bases, Logement Atypique.',
