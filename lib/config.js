...
export const siteConfig = {
  ...
  ogImage: 'https://corentinrobert.fr/og-image.jpg',
  ogLogo: 'https://corentinrobert.fr/images/profile.svg',
  twitter: {
  ...
  social: {
    ...
    spotify: 'https://open.spotify.com/user/your_spotify_id' // À remplacer par votre vrai lien Spotify
  },
  homepage: {
    topPostsCount: 3
  },
  ...
  projects: [
    {
      ...
      description: 'Plateforme de logements exceptionnels — développé avec mon frère',
      link: 'https://logement-atypique.fr/',
      status: 'active',
    ...
    },
    {
      ...
      description: '20 scrapers publics, 154 utilisateurs, 97.3% de succès',
      link: 'https://apify.com/corent1robert',
      status: 'active',
    ...
    {
      title: 'Outreacher',
      description: 'Agence d\'outbound marketing — prospection automatisée pour mes clients',
      link: 'https://www.outreacher.fr/',
      status: 'active',
      image: '/images/profile.jpg',
      imageAlt: 'Corentin Robert - Fondateur d\'Outreacher, agence d\'outbound marketing et prospection automatisée'
    },
    {
      title: 'Rare Item Club',
      description: 'E-commerce sneakers d\'occasion (2022)',
      link: null,
      status: 'stopped'
    },
    {
      title: 'InstaNinja',
      description: 'Automatisation de compte Instagram (2019)',
      link: null,
      status: 'stopped'
    }
  ],
  seo: {
    ...
    pages: {
      home: {
        title: 'Corentin Robert - Consultant Scraping & Automatisation',
