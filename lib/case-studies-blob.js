...
export async function getCaseStudiesFromBlob() {
  // ⚠️ Important : on ne s'appuie plus sur le cache pour garantir
  // que les nouveaux cas d'usage générés par le cron sont visibles
  // immédiatement, même dans un même process Lambda.
  // (On garde cachedCaseStudies uniquement comme fallback en cas d'erreur réseau)
