      ...
      <div className="flex flex-col min-h-screen mt-4 sm:mt-8">
        <div className="flex flex-col items-center">
          <div className="w-full max-w-xl">
            <aside className="mb-8 sm:mb-16 tracking-tight">
              <div className="lg:sticky lg:top-20">
                <nav className="flex flex-row items-start relative px-0 pb-0 fade md:overflow-auto scroll-pr-6 md:relative" id="nav">
                  <div className="flex flex-row space-x-0 pr-4 sm:pr-10">
                    ...
                    <Link href="/a-propos" className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex align-middle relative py-1 px-2 m-1">
                      à propos
                    </Link>
                    <Link href="/ressources" className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex align-middle relative py-1 px-2 m-1">
                      ressources
                    </Link>
                    <button
