...
export default function CaseStudiesIndex({ topCaseStudies: initialTopCaseStudies, sectorsWithCounts, viewsMap = {}, todaysCaseStudies = [], totalCount = 0 }) {
  ...
  const pageSEO = generatePageSEO({
    ...
    description: `Découvrez comment le scraping et l'automatisation peuvent transformer votre business. ${totalCount ? totalCount.toLocaleString('fr-FR') : '6 500+'} cas d'usage concrets par secteur : immobilier, santé, artisanat, e-commerce, finance, restauration...`,
    path: '/cas-usage',
      ...
      <main className="min-w-0 mt-6 flex flex-col">
        <section className="mb-8">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mb-8 tracking-tight">
            ...
            Plus de <strong className="text-neutral-900 dark:text-neutral-100">{totalCount ? totalCount.toLocaleString('fr-FR') : '6 500+'} cas d'usage concrets</strong> par <strong className="text-neutral-900 dark:text-neutral-100">secteur</strong> avec exemples réels et données extractibles.
          </p>
        </section>
