      ...
      <section aria-label="Présentation">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-neutral-900 dark:bg-neutral-100 text-neutral-100 dark:text-neutral-900 text-sm font-medium hover:opacity-90 transition-opacity"
          >
