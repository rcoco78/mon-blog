...
export default function RealEstateGenerator() {
  ...
  const toolData = {
    ...
    howToSteps: [
      {
        name: 'Télécharger les templates',
        text: 'Entrez votre email pour recevoir la collection complète de templates de descriptions immobilières par email.'
      },
      {
        name: 'Choisir le template adapté',
        text: 'Sélectionnez le template qui correspond au type de bien : appartement, maison, luxe, etc.'
      },
      {
        name: 'Personnaliser la description',
        text: 'Adaptez le template avec les caractéristiques spécifiques du bien : superficie, localisation, équipements, etc.'
      },
      {
        name: 'Optimiser avec les mots-clés',
        text: 'Utilisez les suggestions de mots-clés SEO fournies pour améliorer la visibilité de votre annonce.'
      }
    ],
    testimonials: [
      {
  ...
  const faqItems = [
    {
      ...
      answer: 'Entrez votre email pour recevoir les templates. Choisissez le template adapté à votre bien, personnalisez-le avec les caractéristiques spécifiques et utilisez les suggestions de mots-clés SEO.'
    },
    {
    ...
    {
      question: 'Puis-je modifier les templates ?',
      answer: 'Oui, vous pouvez personnaliser tous les templates selon vos besoins. Si vous avez besoin de templates sur-mesure, contactez-moi pour discuter de votre projet.'
    },
    {
  ...
  return (
    <>
      ...
      <main className="min-w-0 mt-6 flex flex-col">
        {/* Breadcrumb */}
        <BreadcrumbTools toolName={toolData.name} toolPath="/outils/real-estate-generator" />
