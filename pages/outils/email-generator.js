...
export default function EmailGenerator() {
    ...
    howToSteps: [
      {
        ...
        text: 'Entrez votre email pour recevoir la collection complète de templates d\'emails par email.'
      },
      {
        name: 'Choisir le template adapté',
        text: 'Sélectionnez le template qui correspond à votre objectif : prospection, relance, présentation, etc.'
      },
      {
        name: 'Personnaliser le contenu',
        text: 'Adaptez le template avec les informations spécifiques à votre prospect et votre offre.'
      },
      {
        name: 'Envoyer et suivre',
        text: 'Envoyez votre email personnalisé et suivez les taux de réponse pour optimiser vos campagnes.'
      }
    ],
    testimonials: [
      {
  ...
  return (
    ...
    <main className="min-w-0 mt-6 flex flex-col">
        {/* Breadcrumb */}
        <BreadcrumbTools toolName={toolData.name} toolPath="/outils/email-generator" />
