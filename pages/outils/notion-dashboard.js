        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="order-1 md:order-2">
              ...
              <h1 className="hidden md:block font-semibold text-2xl mb-4 tracking-tighter">
                {toolData.name}
              </h1>
              
              <p className="hidden md:block text-neutral-600 dark:text-neutral-400 tracking-tight mb-8">
                {toolData.description}
              </p>
